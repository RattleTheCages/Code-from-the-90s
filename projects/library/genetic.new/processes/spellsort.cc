...
/**  **************************************************************************/ 
    ...
    int  score[population];
    char wordtry[population][SPELLSORT_DEFAULT_NUMBER_OF_CHROMOSOMES+1];
    char wordplc[population][SPELLSORT_DEFAULT_NUMBER_OF_CHROMOSOMES+1];
    int  worddleft;
    int  worddright;
    int  pair;
